document.addEventListener("DOMContentLoaded", () => {
    ...
    const laboratoriesContent = document.querySelector(".laboratories-content");
    ...
    function checkOverflow() {
      ...
      if (contentWidth > windowWidth || windowWidth <= 768) {
        ...
        if (laboratoriesContent) laboratoriesContent.classList.remove("sidebar-active");
    ...
    menuToggle?.addEventListener("click", () => {
      ...
      laboratoriesContent?.classList.toggle("sidebar-active");
    ...
    overlay?.addEventListener("click", () => {
      ...
      laboratoriesContent?.classList.remove("sidebar-active");
