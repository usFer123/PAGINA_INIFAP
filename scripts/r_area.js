document.addEventListener("DOMContentLoaded", () => {
  ...
  const researchAreaContent = document.querySelector(".research-area-content")
  ...
  function checkOverflow() {
    ...
    if (contentWidth > windowWidth || windowWidth <= 768) {
      ...
      if (researchAreaContent) researchAreaContent.classList.remove("sidebar-active")
  ...
  menuToggle?.addEventListener("click", () => {
    ...
    researchAreaContent?.classList.toggle("sidebar-active")
  ...
  overlay?.addEventListener("click", () => {
    ...
    researchAreaContent?.classList.remove("sidebar-active")
